<template>
    <div>
      ...
      <el-row :gutter="20">
        <el-col :span="20" :offset="2" class="rowStyle">
                      ...
                      <el-col :span="12" :offset="6">
                        <div class="grid-content bg-purple">
                          <el-form status-icon ref="ruleForm2" label-width="100px" class="demo-ruleForm">
                            <el-form-item label="请输入原密码" prop="pass" class="inputStyle">
                              <el-input type="password" autocomplete="off" placeholder="请输入密码"></el-input>
                            </el-form-item>
                            <el-form-item>
                              <el-button type="primary"><router-link to="/ChangePaSe">确认</router-link></el-button>
                            </el-form-item>
                          </el-form>
                        </div>
                      </el-col>
...
<script>
    ...
    import errorTask from '../tables/errorTask.vue';
    import ErrorDetail from '../page/ErrorDetail.vue';
    ...
    export default {
      data() {
        ...
        components:{
            vPageTitle,hoverRow,stripedRow,borderTable,condensedTable,fixedHeaderTable,fixedColumnTable,errorTask,ErrorDetail
        },
        methods: {
          //  分页方法
